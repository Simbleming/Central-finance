...
<html>
	...
	<body>
						...
						<div class="col-sm-12 col-md-12">
							<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
								<table id="newsTable" class="table table-bordered table-hover example1_x">
									<tbody>
										...
										<tr>
											...
											<td class="rightTd">注：请上传1024*600以上尺寸的图片</td>
											<td style="width: 20%;">
								...
								<div style="text-align: center;">
									<button class="newsSave saveBtn" onclick="newsSave();">保存</button>
								</div>
							</div>
						</div>
					</div>
		...
		<script>
			function newsSave(){
				var newsCategoryLen = document.getElementById('newsCategory').value.length;
				if(newsCategoryLen>10){
